  ...
  "Home": {
    ...
    "Image11": {
      "custom": {
        ...
        "src": "/app-assets/I%20design%20products1.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image2": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Portfolio%20Creator..svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image38": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/jj-ying-azCTGObXR14-unsplash.jpg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image42": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/PRODUCT%20DESIGN.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image43": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/pawel-czerwinski-tMbQpdguDVQ-unsplash.jpg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image46": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/usgs-hoS3dzgpHzw-unsplash.jpg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image49": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/rene-bohmer-YeUVDKZWSZ4-unsplash.jpg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image76": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/PRODUCT%20DESIGNER.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image154": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/rocket%20(2).png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image161": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/TESTIMONIALS.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image162": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/604788d804dfe4ec1de7bb97_image-1-compressed2.jpg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image163": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/double%20quote.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image168": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/arrow-down-sign-to-navigate%20(1).png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image189": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Lets%20get%20on%20call.svg"
      },
      "callbacks": {
        "onClick": [
          {
